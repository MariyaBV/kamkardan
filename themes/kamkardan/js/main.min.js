...
window.addEventListener("DOMContentLoaded",(function(){document.querySelectorAll(".tel").forEach((function(e){var t;function n(e){e.keyCode&&(t=e.keyCode);var n=this.selectionStart,i=this.value.length;n<1&&8!==e.keyCode&&46!==e.keyCode&&e.preventDefault();var l="+_ (___) ___ ____",a=0,s=(l.replace(/\D/g,""),this.value.replace(/\D/g,"")),u=l.replace(/[_\d]/g,(function(e){return a<s.length?s.charAt(a++):e}));-1!=(a=u.indexOf("_"))&&(u=u.slice(0,a));var r=l.substr(0,this.value.length).replace(/_+/g,(function(e){return"\\d{1,"+e.length+"}"})).replace(/[+()]/g,"\\$&");(!(r=new RegExp("^"+r+"$")).test(this.value)||this.value.length<2||t>47&&t<58)&&(this.value=u),"blur"==e.type&&this.value.length<2&&(this.value="");var h=n+(this.value.length-i);h>0&&h<this.value.length&&this.setSelectionRange(h,h)}e.addEventListener("input",n,!1),e.addEventListener("focus",n,!1),e.addEventListener("blur",n,!1),e.addEventListener("keydown",n,!1),e.addEventListener("keydown",(function(e){0==this.selectionStart&&this.selectionEnd==this.value.length&&(this.value="")}),!1),e.addEventListener("input",(function(e){""===this.value&&(this.value="+")}),!1)}))}));
