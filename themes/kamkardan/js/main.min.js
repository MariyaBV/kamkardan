...
jQuery(document).ready((function(a){a("#callbackRequestForm").submit((function(e){e.preventDefault();var t=a("#callback-name").val(),r=a("#callback-phone").val();a.ajax({url:custom_ajax_obj.ajax_url,type:"POST",dataType:"json",data:{action:"get_cart_data"},success:function(e){if(e.success){var c=e.data;a.ajax({url:custom_ajax_obj.ajax_url,type:"POST",data:{action:"submit_callback_order",name:t,phone:r,cart_data:c},success:function(e){e.success?(alert(e.data),a("#closeCallbackForm").trigger("click")):alert("Ошибка: "+e.data)},error:function(a,e,t){console.error("Ошибка при отправке данных формы:",a.responseText),alert("Ошибка при отправке данных формы.")}})}else alert("Ошибка при получении данных корзины.")},error:function(a,e,t){console.error("Ошибка при получении данных корзины:",a.responseText),alert("Ошибка при получении данных корзины.")}})}))}));
