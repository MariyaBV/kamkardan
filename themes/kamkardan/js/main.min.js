...
jQuery(document).ready((function(a){a("#callbackRequestForm").submit((function(e){e.preventDefault();var r=a("#callback-name").val(),t=a("#callback-phone").val();a.ajax({url:custom_ajax_obj.ajax_url,type:"POST",dataType:"json",data:{action:"get_cart_data"},success:function(e){if(e.success){var c=e.data;a.ajax({url:custom_ajax_obj.ajax_url,type:"POST",data:{action:"submit_callback_order",name:r,phone:t,cart_data:c},success:function(e){e.success?(alert("Заказ успешно создан. ID: "+e.data),a.ajax({url:custom_ajax_obj.ajax_url,type:"POST",data:{action:"clear_cart"},success:function(){a("#closeCallbackForm").trigger("click"),location.reload()},error:function(a,e,r){console.error("Ошибка при очистке корзины:",a.responseText)}})):alert("Ошибка: "+e.data)},error:function(a,e,r){console.error("Ошибка при отправке данных формы:",a.responseText),alert("Ошибка при отправке данных формы.")}})}else alert("Ошибка при получении данных корзины.")},error:function(a,e,r){console.error("Ошибка при получении данных корзины:",a.responseText),alert("Ошибка при получении данных корзины.")}})}))}));
