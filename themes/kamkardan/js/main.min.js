...
$(document).ready((function(){$(".button-vacancy").on("click",(function(){$(".vacancy-callback.block-callback-form").show()})),$("#closeCallbackFormVacancy").on("click",(function(){$(".vacancy-callback.block-callback-form").hide()}))}));
...
jQuery(document).ready((function(a){a("#callbackButton").on("click",(function(){a("#callbackForm").show()})),a("#callbackButtonCart").on("click",(function(){a("#callbackForm").show()})),a("#closeCallbackForm").on("click",(function(){a("#callbackForm").hide()})),a("#callbackRequestForm").on("submit",(function(c){c.preventDefault();var l=a("#callback-name").val(),n=a("#callback-phone").val(),o=a("#callback-type").val(),e=new FormData;e.append("name",l),e.append("phone",n),e.append("type",o),e.append("action","callback_request"),fetch("/wp-admin/admin-ajax.php",{method:"POST",body:e}).then((a=>a.json())).then((c=>{a("#callbackRequestFormThanks").show(),a("#closeCallbackForm").trigger("click"),a("#OKCallbackFormThanks").on("click",(function(){a("#callbackRequestFormThanks").hide()})),a("#callbackForm").hide()})).catch((a=>{console.error("Ошибка:",a)}))}))}));
