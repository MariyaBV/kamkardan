...
$(document).ready((function(){var e,a,l;e=window.location.href,a=$('a[href="#catalog"]'),l=$("#block-catalog"),$("#main-header"),e.includes("#catalog")&&a.length?(a.addClass("selected-item-menu"),l.addClass("visible")):(a.removeClass("selected-item-menu"),l.removeClass("visible")),$('a[href="#catalog"]').on("click",(function(e){e.preventDefault();var a=$(this),l=$("#block-catalog");a.addClass("selected-item-menu"),l.addClass("display_block"),setTimeout((()=>{l.addClass("visible")}),200),history.pushState(null,null,"#catalog")})),$("#close-catalog-menu").on("click",(function(e){e.preventDefault();var a=$('a[href="#catalog"]'),l=$("#block-catalog");a.removeClass("selected-item-menu"),l.removeClass("visible"),setTimeout((()=>{l.removeClass("display_block")}),500),history.pushState(null,null,window.location.pathname+window.location.search)})),$("#close-catalog-menu-back").on("click",(function(e){e.preventDefault();var a=$("#block-catalog");a.removeClass("visible"),setTimeout((()=>{a.removeClass("display_block")}),500),history.pushState(null,null,window.location.pathname+window.location.search)})),$("#burger-menu").click((function(){$(this).toggleClass("active"),$("#site-navigation").toggleClass("visible");var e=$(".sub-menu");e.hasClass("show")&&(e.removeClass("show"),$(this).removeClass("selected-item-menu"));var a=$("#block-catalog");a.hasClass("visible")&&(a.removeClass("visible"),history.pushState(null,null,window.location.pathname+window.location.search))}))})),$(document).ready((function(e){function a(a){a.preventDefault(),e("#catalog-sidebar").removeClass("visible-mobile")}e("#show-catalog-sidebar").on("click",(function(a){a.preventDefault(),e("#catalog-sidebar").addClass("visible-mobile")})),e("#close-catalog-sidebar").on("click",a),e("#close-catalog-sidebar-x").on("click",a)})),$(document).ready((function(){$('a[href="#uslugi"]').on("click",(function(e){e.preventDefault();var a=$(".sub-menu");a.hasClass("show")?(a.removeClass("show"),$(this).removeClass("selected-item-menu")):(a.addClass("show"),$(this).addClass("selected-item-menu"))}))}));
